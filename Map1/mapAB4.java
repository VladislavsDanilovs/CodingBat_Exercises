    ...
    public static Map<String, String> mapAB4(Map<String, String> map) {
        ...
        if(map.get("a") != null && map.get("b") !=null  ){
            if(map.get("a").length() != map.get("b").length()){
                String mapValueLength = map.get("a").length() > map.get("b").length() ? map.get("a") : map.get("b");
                map.put("c", mapValueLength);
            }
            if(map.get("a").length() == map.get("b").length()){
                String mapValueLength = "";
                map.put("a", mapValueLength);
                map.put("b", mapValueLength);
            }
        }
